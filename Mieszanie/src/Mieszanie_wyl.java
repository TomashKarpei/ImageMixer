	...
	import java.math.*;
	public class Mieszanie_wyl {
	 BufferedImage image_1, image_2, image;
	 int width;
	 int height;

	 public Mieszanie_wyl() {
	 ...
	 int red = 0, blue = 0, green = 0;
		 ...
		 x = red_1/255 + red_2/255 - 2*(red_1 / 255)*(red_2 / 255);
		 y = green_1/255 + green_2/255 - 2*(green_1 / 255)*(green_2 / 255);
		 z = blue_1/255 + blue_2/255 - 2*(blue_1 / 255)*(blue_2 / 255);
	 ...
	 File ouptut = new File("mieszanie_wyl.jpg");
	 ...
	 {
		 Mieszanie_wyl obj = new  Mieszanie_wyl();
	 }
	}