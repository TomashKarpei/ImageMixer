	...
	import java.math.*;
	public class Mieszanie_przez {
	 BufferedImage image_1, image_2, image;
	 int width;
	 int height;

	 public Mieszanie_przez() {
	 ...
	 int red = 0, blue = 0, green = 0;
		 ...
		 x =  (1 - a) * (red_2 / 255) + a * (red_1 / 255);
		 y = (1 - a) * (green_2 / 255) + a * (green_1 / 255);
		 z = (1 - a) * (blue_2 / 255) +  a * (blue_1 / 255);
	 ...
	 File ouptut = new File("mieszanie_przez.jpg");
	 ...
	 {
		 Mieszanie_przez obj = new  Mieszanie_przez();
	 }
	}