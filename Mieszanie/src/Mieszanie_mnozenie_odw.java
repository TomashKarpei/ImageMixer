	...
	import java.math.*;
	public class Mieszanie_mnozenie_odw {
	 BufferedImage image_1, image_2, image;
	 int width;
	 int height;

	 public Mieszanie_mnozenie_odw () {
	 ...
	 int red = 0, blue = 0, green = 0;
		 ...
		 x = 1 - (1 - red_1/255) * (1 - red_2/255);
		 y = 1 - (1 - green_1/255) * (1 - green_2/255);
		 z = 1 - (1 - blue_1/255) * (1 - blue_2/255);		 
	 ...
	 File ouptut = new File("mieszanie_mnozenie_odw.jpg");
	 ...
	 {
		 Mieszanie_mnozenie_odw  obj = new  Mieszanie_mnozenie_odw ();
	 }
	}