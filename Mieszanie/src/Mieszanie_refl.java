	...
	import java.math.*;
	public class Mieszanie_refl {
	 BufferedImage image_1, image_2, image;
	 int width;
	 int height;

	 public Mieszanie_refl() {
	 ...
	 int red = 0, blue = 0, green = 0;
		 ...
		 x =  (red_1 / 255)*(red_1 / 255)/ (1 - red_2 / 255);
		 y = (green_1 / 255)*(green_1 / 255)/ (1 - green_2 / 255);
		 z = (blue_1 / 255)*(blue_1 / 255)/ (1 - blue_2 / 255);
	 ...
	 File ouptut = new File("mieszanie_refl.jpg");
	 ...
	 {
		 Mieszanie_refl obj = new  Mieszanie_refl();
	 }
	}