	...
	import java.math.*;
	public class Mieszanie_odejmowanie {
	 BufferedImage image_1, image_2, image;
	 int width;
	 int height;

	 public Mieszanie_odejmowanie () {
	 ...
	 int red = 0, blue = 0, green = 0;
		 ...
		 x = (red_1/255) + (red_2/255) - 1;
		 y = (green_1/255) + (green_2/255) - 1;
		 z = (blue_1/255) + (blue_2/255) - 1;
	 ...
	 {
		 Mieszanie_odejmowanie obj = new  Mieszanie_odejmowanie ();
	 }
	}