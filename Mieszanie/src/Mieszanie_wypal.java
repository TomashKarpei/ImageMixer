	...
	import java.math.*;
	public class Mieszanie_wypal {
	 BufferedImage image_1, image_2, image;
	 int width;
	 int height;

	 public Mieszanie_wypal() {

	 try {
	 //odczyt obrazu z pliku
	 File input1 = new File("FoW1.jpg");
	 File input2 = new File("meme_g.jpg");
	 ...
	 int red = 0, blue = 0, green = 0;
		 ...
		 x =  1 - ((1 - red_1 / 255)/ (red_2 / 255));
		 y = 1 - ((1 - green_1 / 255)/ (green_2 / 255));
		 z = 1 - ((1 - blue_1 / 255)/ (blue_2 / 255));
		 



		 if (x * 255 > 255 || x * 255 < 0) {
			 red = (c1.getRed());
		 } else {
			 red = (int) (x * 255);
		 }
		 if (y * 255 > 255 || y * 255 < 0) {
			 green = (c1.getGreen());
		 } else {
			 green = (int) (y * 255);
		 }
		 if (z * 255 > 255 || z * 255 < 0) {
			 blue = (c1.getBlue());
		 } else {
			 blue = (int) (z * 255);
		 }
	 ...
	 File ouptut = new File("mieszanie_wypal.jpg");
	 ...
	 {
		 Mieszanie_wypal obj = new  Mieszanie_wypal();
	 }
	}