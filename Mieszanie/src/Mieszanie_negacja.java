	...
	import java.math.*;
	public class Mieszanie_negacja {
	 BufferedImage image_1, image_2, image;
	 int width;
	 int height;

	 public Mieszanie_negacja () {
	 ...
	 int red = 0, blue = 0, green = 0;
		 ...
		 x = 1 - red_1/255 - red_2/255;
		 if (x < 0) x = 1 - x * (-1);
		 else x = 1 - x;
		 y = 1 - green_1/255 - green_2/255;
		 if (y < 0) y = 1 - y * (-1);
		 else y = 1 - y;
		 z = 1 - blue_1/255 - blue_2/255;
		 if (z < 0) z = z * (-1);
		 else z = 1 - z;
	 ...
	 {
		 Mieszanie_negacja  obj = new  Mieszanie_negacja ();
	 }
	}